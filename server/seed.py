...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        firearm_6 = Item(title="Sig Sauer P320", description="A striker-fired modular handgun.", category="firearm", price=550, img_url='https://example.com/images/sigp320.jpg')
        firearm_7 = Item(title="Beretta 92FS", description="A reliable 9mm pistol with a classic design.", category="firearm", price=600, img_url='https://example.com/images/beretta92fs.jpg')
        firearm_8 = Item(title="Springfield XD", description="A durable and ergonomic 9mm handgun.", category="firearm", price=500, img_url='https://example.com/images/springfieldxd.jpg')
        firearm_9 = Item(title="Ruger 10/22", description="A popular .22 LR semi-automatic rifle.", category="firearm", price=300, img_url='https://example.com/images/ruger1022.jpg')
        firearm_10 = Item(title="HK VP9", description="A well-engineered striker-fired 9mm pistol.", category="firearm", price=700, img_url='https://example.com/images/hkvp9.jpg')
